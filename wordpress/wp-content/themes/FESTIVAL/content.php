...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		$titre_francais = get_post_meta($post->ID, 'Titre_Français', true);
		?>
		...
		<?php echo $langue ?></br></span>
		<?php endif; ?>
		<?php if(false === empty($titre_francais)): ?>
		<span class="champs-persos-item">
		<i class=”champs-persos-label”>Titre Français : </i>
		<?php echo $titre_francais ?></br></span>
		<?php endif; ?>
		<?php if(false === empty($prix)): ?>
		<span class="champs-persos-item">
		<i class=”champs-persos-label”>Prix : </i>
		<?php echo $prix ?></br></span>
		<?php endif; ?>
